...
class ReportChecker
  def self.call(event:, context:)
    ...
    notifier.ping "ReportChecker raised the following Exception: #{e.exception}"
    raise
  end

  def self.notifier
    Slack::Notifier.new(ENV["SLACK_WEBHOOK_URL"], channel: "#alerts", username: "PsdFileExportReportChecker")
  end
end
